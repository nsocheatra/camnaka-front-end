...
export default function DiapersWipesPage() {
  const { t } = useLanguage();
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] items-center">
          <div>
            ...
            <h1 className="text-4xl font-bold text-foreground mb-4">{t('diapersWipes')}</h1>
            <p className="text-lg text-foreground/80 mb-6">{t('diapersWipesDesc')}</p>
